...
#include "../../../external/imgui/imgui_impl_dx10.h"
#include "../../../external/imgui/imgui_impl_win32.h"
#include "../../../external/minhook/MinHook.h"
#include "../../../utils/utils.h"
#include "../../hooks.h"
#include "hook_directx10.h"
...
static bool CreateDeviceD3D10(HWND hWnd)
{
    ...
    HRESULT hr = D3D10CreateDeviceAndSwapChain(
        NULL, D3D10_DRIVER_TYPE_NULL, NULL, 0, D3D10_SDK_VERSION, &swapChainDesc, &g_pSwapChain, &g_pd3dDevice);
    if (hr != S_OK)
    {
...
namespace DX10
{
    void Hook(HWND hwnd)
    {
        ...
        if (g_pd3dDevice)
        {
            Runtime::InitializeContext(hwnd);
...
namespace DX10
{
    void Hook(HWND hwnd)
    {
        LOG("[!] DirectX10 backend is not enabled!\n");
    }
    void Unhook() {}
}  // namespace DX10
#endif
